                ...
                <div class="col-sm-12 pt-5 my-auto">
                    <div class="col-12 col-lg-6 col-md-12 mx-auto w-100">
                        ...
                        <div class="desc-title">
                            <p class="title">Masuk atau buat akun untuk memulai</p>
                        </div>
                        ...
                        <div class="loginForm">
                            ...
                            <form id="loginForm">
                                ...
                                <p class="text-center">belum punya akun ? register <a href="<?= base_url('register') ?>" style="color: #dc3545">disini</a></p>
                            </form>
                        </div>
                    </div>
                </div>
