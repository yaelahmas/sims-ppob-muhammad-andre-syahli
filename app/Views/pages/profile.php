    ...
    <div class="form-section mx-auto" style="max-width: 500px;">
        <form>
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" placeholder="masukan email anda" value="<?= esc($profile['data']['email'] ?? ''); ?>" readonly>
            </div>

            <div class="mb-3">
                <label for="first_name" class="form-label">Nama Depan</label>
                <input type="text" class="form-control" id="first_name" placeholder="nama depan" value="<?= esc($profile['data']['first_name'] ?? ''); ?>" readonly>
            </div>

            <div class="mb-3">
                <label for="last_name" class="form-label">Nama Belakang</label>
                <input type="text" class="form-control" id="last_name" placeholder="nama belakang" value="<?= esc($profile['data']['last_name'] ?? ''); ?>" readonly>
            </div>

            <div class="d-grid">
                <a href="<?= base_url('edit-profile'); ?>" class="btn btn-danger btn-block">Edit profil</a>
                <a href="<?= base_url('logout'); ?>" class="btn btn-outline-danger btn-block">Logout</a>
            </div>
        </form>
    </div>
</div>
